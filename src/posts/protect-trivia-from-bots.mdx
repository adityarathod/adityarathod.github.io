...
description: 'How people cheat at trivia games, and how the companies running them could stop this from happening.'
date: 2017-12-17T01:00:00Z
displayDate: 'December 16, 2017'
draft: false
hasMath: false
---

import svg from './images/trivia-diagram.svg'
...
![System diagram](./images/trivia-diagram.png)
...
![A more confusing picture](./images/hq-fooled.png)
